export default function CostDataForm() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-stack-md">
        <div className="flex flex-col gap-unit">
          ...
          <div className="relative">
            ...
            <input className="w-full bg-surface-container border-none rounded-DEFAULT pl-10 pr-4 py-3 focus:ring-2 focus:ring-primary-container transition-all font-body-md px-6" placeholder="0.00" step="0.01" type="number"/>
          </div>
        </div>
        <div className="flex flex-col gap-unit">
