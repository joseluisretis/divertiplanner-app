...
import { EyeIcon, Key01Icon, UserIcon } from "hugeicons-react";
      ...
      <main className="min-h-screen flex flex-col px-container-margin py-8 max-w-md mx-auto relative overflow-hidden">
        ...
        <div className="mb-10">
          <h1 className="font-headline-lg-mobile text-headline-lg-mobile text-primary tracking-tight flex items-center gap-1">
            DivertiPlanner
            <span className="text-secondary-container text-2xl font-black">
              +
            </span>
          </h1>
        ...
        <form className="flex flex-col space-y-6" onSubmit={handleLogin}>
          ...
          <div className="space-y-2">
            ...
            <div className="relative flex items-center bg-[#F1F5F9] rounded-xl px-4 py-4 focus-within:ring-2 ring-primary transition-all">
              ...
              <UserIcon className="w-6 h-6 text-outline mr-3" />
              <Input
                ref={emailRef}
                className="bg-transparent border-none focus-visible:ring-0 focus-visible:ring-offset-0 focus:ring-0 w-full h-auto p-0 text-on-surface placeholder:text-outline-variant font-body-md shadow-none outline-none"
                id="username"
          ...
          <div className="space-y-2">
            ...
            <div className="relative flex items-center bg-[#F1F5F9] rounded-xl px-4 py-4 focus-within:ring-2 ring-primary transition-all">
              ...
              <Key01Icon className="w-6 h-6 text-outline mr-3" />
              <Input
                ref={passwordRef}
                className="bg-transparent border-none focus-visible:ring-0 focus-visible:ring-offset-0 focus:ring-0 w-full h-auto p-0 text-on-surface placeholder:text-outline-variant font-body-md shadow-none outline-none"
                id="password"
              ...
              <Button
                variant={null}
                size={null}
                className="text-outline-variant hover:text-primary transition-colors cursor-pointer border-none bg-transparent hover:bg-transparent shadow-none p-0 h-auto active:translate-y-0"
                type="button"
              ...
              >
                ...
                {showPassword ? (
                  <EyeClosed className="w-6 h-6 text-outline" />
                ) : (
                  <EyeIcon className="w-6 h-6 text-outline" />
                )}
              </Button>
            </div>
          </div>
          ...
          <Button
            variant={null}
            size={null}
            className="bg-primary text-lg font-bold text-white py-4 rounded-xl font-button custom-shadow active:scale-95 transition-transform duration-200 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed w-full h-auto border-none outline-none justify-center"
            type="submit"
            disabled={isLoading}
          >
        ...
        <div className="mt-auto pt-12 pb-6">
          ...
          <div className="flex justify-center items-center gap-6 relative">
            ...
            <Button
              variant={null}
              size={null}
              className="w-14 h-14 bg-white custom-shadow rounded-full flex items-center justify-center grayscale cursor-not-allowed opacity-50 border-none p-0 hover:bg-white active:translate-y-0"
              type="button"
              disabled
            >
              <svg
            ...
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24">
                ...
                />
                <path
                  d="M16.04 18.013c-1.09.693-2.459 1.078-4.04 1.078a7.077 7.077 0 0 1-6.723-4.823L1.24 17.385C3.198 21.302 7.27 24 12 24c3.055 0 5.771-1.027 7.91-2.782l-3.87-3.205Z"
                  fill="#FBBC05"
                />
                <path
                  d="M19.91 21.218C22.408 19.107 24 15.897 24 12c0-.853-.07-1.533-.21-2.182H12v4.637h6.736a5.79 5.79 0 0 1-2.496 3.764l3.67 3.003l-.001-.004Z"
                  fill="#4285F4"
                />
                <path
                  d="M1.24 6.65L5.265 9.765A7.01 7.01 0 0 1 12 19.091V24H1.24V6.65Z"
                  fill="#34A853"
                />
              </svg>
            </Button>
